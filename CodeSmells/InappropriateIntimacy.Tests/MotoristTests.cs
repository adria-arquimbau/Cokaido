namespace InappropriateIntimacy.Tests
{
    ...
    public class MotoristTests
    {
        ...
        {
            Assert.AreEqual(RiskFactor.HIGH_RISK, createMotoristWithPointsOnLicense(4).license.GetRiskFactor());
        }

        [Test]
        public void MotoristWithNoPointsOnLicenseIsLowRisk()
        {
            Assert.AreEqual(RiskFactor.LOW_RISK, createMotoristWithPointsOnLicense(0).license.GetRiskFactor());
        }

        [Test]
        public void MotoristWithOneToThreePointsOnLicenseIsModerateRisk()
        {
            Assert.AreEqual(RiskFactor.MODERATE_RISK, createMotoristWithPointsOnLicense(1).license.GetRiskFactor());
        }
    }
}